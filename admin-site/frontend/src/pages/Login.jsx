    ...
    <div className="login-page">
            ...
            <div className="hero-content">
              <div className="brand-pill">
                <div className="brand-logo">
                  <img src={logoImage} alt="Awan Rent a Car logo" />
                </div>
                <div>
              ...
              <h2 className="hero-title">
                ...
                <span>from one clean dashboard.</span>
              </h2>

              <p className="hero-text">
                Fast access for bookings, customers, vehicles, and daily admin work in a simple,
                real-world layout.
              </p>

              <div className="hero-points">
                <div className="hero-point">Bookings</div>
                <div className="hero-point">Fleet</div>
                <div className="hero-point">Customers</div>
              </div>
            </div>
          </div>
          ...
          <div className="col-12 col-lg-5 auth-side">
            <div className="login-card">
              ...
              <div className="card-foot">
                <small>{role === "admin" ? "Admin access" : "Driver access"}</small>
              </div>
            </div>
          </div>
        </div>
      ...
      <style>{`
        ...
        .custom-input:focus {
          ...
          box-shadow: 0 0 0 0.18rem rgba(13, 202, 240, 0.10) !important;
